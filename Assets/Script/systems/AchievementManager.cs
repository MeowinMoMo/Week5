...
public class AchievementManager : MonoBehaviour
{
    ...
    private void InitializeAchievements()
    {
        ...
        achievements.Add(new Achievement("Step By Step", "Set your integer to 100 or above.", (object o) => integer >= 100));
        achievements.Add(new Achievement("Not So Precise", "Set your floating point to -1 or above", (object o) => floating_point >= -1f));
    }
